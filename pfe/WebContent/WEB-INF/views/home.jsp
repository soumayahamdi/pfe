...
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.4.4/jquery.min.js"></script>
		  ...
		  timeOut = setTimeout('ajout1()', 10000);
		  }
...
<!--Recherche-->
<form  action="home.html" name="frmMain"  id="frmMain"  method="post" > 
	<div>
	<input TYPE="text" name="search" maxlength=255 value="" placeholder=Search autocomplete=off style="position: absolute; top: 110 px; left: 500 px;"/>  
