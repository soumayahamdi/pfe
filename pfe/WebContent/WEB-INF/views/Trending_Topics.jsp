...
<table>
	<tr>
		<td>
			<fieldset style="position: absolute; width: 370px; top: 50 px; left: 50 px; height: 430px;">
				<legend> <h3>Weekly Trends </h3></legend>		
<iframe width="370" height="400" src='weekly_Trend.html' frameborder="5"> </iframe>  
			</fieldset>
		</td>
		<td>
			<fieldset style="position: absolute; width: 370px; top: 50 px; left: 500 px; height: 430px;">
				<legend> <h3>Daily Trends </h3></legend>
				<iframe width="370" height="400" src='trend.html' frameborder="5"> </iframe> 
				</fieldset>
		</td>
	</tr>
	<div style="position: absolute; top:520px; left:50px; ">
	<iframe width="850" height="400" src="tagcloud.html" frameborder="1"></iframe>
	</div>
