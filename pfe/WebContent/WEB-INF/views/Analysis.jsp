...
<form name="frmMain"  id="frmMain">
	<div>
	<input TYPE="text" id=search maxlength=255 value="" placeholder=Search autocomplete=off style="position: absolute; top: 110 px; left: 500 px;"/>  
	<input type="button" class="affichimag" id=submit src="tt.gif" border="0" style="position: absolute; top: 100 px; left: 680 px; width: 35 px; height: 35 px;" /><br><br>
	</div>
</form>
<ul id="menuDeroulant">
		<li>
		...
		<li>
			<a href="#"onclick="flop()">LinkedIn</a>
			</li>
		<li>
			<a href="#">Twitter</a>
			<ul class="sousMenu">			      
				<li><a href="#" >search using Key word</a></li>
				<li><a href="index.html">Search by area</a></li>
				<li><a href="#" >Trending Topics</a></li>
				<li><a href="#" >Track profiles</a></li>
...
<table>
	...
	<td>
	<img src="wcloud.jpg" style="position: absolute; top: 80 px; left: 550 px; width: 350px; height: 420px;"> </td>
	</tr>
<tr>
	<div id="outerdiv">
		<div id="innerdiv">      
		<iframe width="890" height="400" src='index.html' frameborder="5"> </iframe>
		</div>
	</div>
</tr>
</table>
